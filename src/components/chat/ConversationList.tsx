...
export default function ConversationList() {
  ...
  const filteredConversations = conversations.filter(c => {
      ...
      const other = participants.find((p: Participant) => p.userId !== me?.userId)?.user;
    ...
    <div className="flex flex-col h-full bg-transparent">
      ...
      <div className="p-5 flex flex-col gap-5 bg-zinc-950/40 backdrop-blur-2xl sticky top-0 z-10 border-b border-white/5">
        <div className="flex justify-between items-center">
            <h2 className="text-2xl font-black tracking-tighter text-white">Messages</h2>
            <motion.button 
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-1">
        ...
        {conversations.length === 0 ? (
          ...
          filteredConversations.map((conv) => {
            ...
            const otherParticipant = participants.find((p: Participant) => p.userId !== me?.userId) || participants[0];
