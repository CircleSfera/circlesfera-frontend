import { Home, Search, PlusSquare, MessageCircle, Heart, User, Settings, LogOut, Bookmark, Clapperboard, BarChart3 } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { icon: BarChart3, label: 'Creator Studio', to: '/creator', badge: 0, roles: ['CREATOR', 'BUSINESS'] },
    { icon: User, label: 'Profile', to: profileUrl, badge: 0 },
  ].filter(item => !item.roles || item.roles.includes(profile?.accountType || 'PERSONAL'));
