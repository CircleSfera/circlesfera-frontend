...
import type { SearchResult, SearchHistoryItem, Post } from '../types';
                  ...
                  {searchResults?.users && searchResults.users.length > 0 ? (
                    <div className="space-y-3">
                      {searchResults.users.map((user: SearchUserResult) => (
                        ...
                        >
                          <img
                            src={user.profile.avatar || '#noimage'}
                          ...
                          <div className="min-w-0">
                            <div className="font-bold truncate flex items-center gap-1">
                              ...
                              <VerificationBadge level={user.user?.verificationLevel as VerificationLevel} size={12} />
                            </div>
