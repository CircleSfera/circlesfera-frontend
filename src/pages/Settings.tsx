...
export default function Settings() {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: (data: { fullName?: string; bio?: string; website?: string; isPrivate?: boolean; username?: string }) => 
  ...
  const handleProfileSubmit = (e: React.FormEvent) => {
    ...
    const data: { fullName?: string; bio?: string; website?: string; isPrivate?: boolean; username?: string } = {
      fullName,
      bio,
      website,
      isPrivate,
